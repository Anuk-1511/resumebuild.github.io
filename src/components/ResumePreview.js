      ...
      >
        <div ref={printElem}>
          <HStack>
            ...
            <VStack m={4} alignItems={"flex-start"} spacing={0.5}>
              <Heading as="h4" size="md">
                {about.name ? about.name : "Anubhav Kharwar"}
              </Heading>
              <Text color={"gray.500"}>
          ...
          >
            <HStack spacing={1} >
              <MdMail />{" "}
              <Text >{about.email ? about.email : "AnubhavKharwar@gmail.com"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocalPhone />{" "}
              <Text>{about.phone ? about.phone : "+91874646446"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocationPin />{" "}
              <Text>{about.address ? about.address : "new delhi, delhi"}</Text>
            </HStack>
            <HStack spacing={1}>
              <RiLinkedinBoxFill />{" "}
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <Text>{grade ? grade : "8.0 CGPA"}</Text>
                      </HStack>
                    </VStack>
                  );
                })}
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text fontSize={"sm"} as="p">
                        {desc
                          ? desc
                          : "Passionate Full Stack Developer experienced in designing and implementing end-to-end web applications. Proficient in both client-side and server-side development, adept at integrating diverse technologies to create seamless user experiences."}
                      </Text>
                    </VStack>
                  );
                })}
